...
const PRICES = {
  ...
  yearly: Deno.env.get("STRIPE_YEARLY_PRICE_ID") || "price_yearly_placeholder",
};
...
serve(async (req) => {
  ...
  try {
    ...
    // Get price type from request body
    ...
    const origin = req.headers.get("origin") || "https://caixacertus.lovable.app";
